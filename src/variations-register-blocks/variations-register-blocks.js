...
registerBlockType("myprefix/variations-register-blocks", {
  apiVersion: 2,
  title: "Variations Register Blocks",
  description: __("An heading with orange text.", "textDomain"),
  icon: "lightbulb",
  category: "text",
  attributes: {
    content: {
  ...
  variations: [
    {
      name: "myprefix-default-orange-heading",
      ...
      icon: "lightbulb",
      attributes: {
        placeholder: __("Add some orange text...", "textDomain"),
        textAlign: "left",
