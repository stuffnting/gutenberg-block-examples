 ...
 */ 
 ...
 add_filter( 'get_block_type_variations', 'myprefix_add__core_block_type_variations', 10, 2 );

 function myprefix_add__core_block_type_variations( $variations, $block_type ) {
