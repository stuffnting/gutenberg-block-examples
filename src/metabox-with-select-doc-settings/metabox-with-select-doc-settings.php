...
add_action( 'enqueue_block_editor_assets', 'myprefix_enqueue_metabox_with_select_doc_settings_editor_assets' );

function myprefix_enqueue_metabox_with_select_doc_settings_editor_assets() {
  ...
  wp_enqueue_script(
    'myprefix-metabox-with-select-doc-settings-script',
...
define('METABOX_WITH_SELECT_DOC_SETTINGS_META', '_myprefix_metabox_with_select_doc_settings_meta');

add_action( 'init', 'myprefix_register_metabox_with_select_doc_settings_meta' );

function myprefix_register_metabox_with_select_doc_settings_meta() {
  register_meta( 
    'post', 
...
function myprefix_meta_with_select_doc_settings_content_filter( $content ) {
  $value = get_post_meta( get_the_ID(), METABOX_WITH_SELECT_DOC_SETTINGS_META, true );
