 ...
 */
if ( file_exists( __DIR__ . '/meta-inner-blocks.metafield.json' ) ) {
  
  $block_json = file_get_contents( 'meta-inner-blocks.metafield.json', true );
  ...
  error_log( "ERROR: meta-inner-blocks.metafield.json file not found. Logged from line" . __LINE__ . " in " . __FILE__ );
}
