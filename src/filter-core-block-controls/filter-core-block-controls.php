...
add_action( 'enqueue_block_editor_assets', 'myprefix_enqueue_filter_core_block_controls_editor_assets' );

function myprefix_enqueue_filter_core_block_controls_editor_assets() {
